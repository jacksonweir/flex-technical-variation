...
#
# Each probe barcode in this dataset is a distinct ligand treatment condition
...
INPUT_CSV     <- file.path(RESULTS_DIR, "DE_A375_flexv2_FindAllMarkers_wilcox.csv")
LOG2FC_CUTOFF <- 0.3
PVAL_CUTOFF   <- 0.05
...
ggsave(file.path(FIGURES_DIR, "fig2b_stacked_barplot_DE_per_probe_barcode_a375.pdf"),
       p, width = 9, height = 4, device = cairo_pdf)
