...
## Recurrently Probe Barcode-Affected Genes

These genes appear recurrently in probe barcode DE results across independent datasets and have high η² (η² ≥ 5% in VCC dataset). If any of these appear in your DE gene list, they are almost certainly technical artifacts:
